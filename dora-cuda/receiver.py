#!/usr/bin/env python
"""Dora CUDA IPC benchmark receiver.

Receives CUDA IPC handles, opens them as PyTorch tensors, and measures
end-to-end latency.  Supports both CUDA zero-copy and CPU fallback.
"""
